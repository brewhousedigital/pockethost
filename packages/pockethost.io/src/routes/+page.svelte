<script lang="ts">
  import FeatureCard from '$components/svelte/FeatureCard.svelte'
  import AuthStateGuard from '$components/svelte/helpers/AuthStateGuard.svelte'
  import HomepageHeroAnimation from '$components/svelte/HomepageHeroAnimation.svelte'
  import InstanceGeneratorWidget from '$components/svelte/InstanceGeneratorWidget.svelte'
